    ...
    <div class="sns-list__item">
      <p class="sns-list__icon">
        <a href="https://twitter.com/study_dedede" target="_blank">
          <img src="../../public/assets/img/icon/icon-twitter.svg" draggable="false" alt="Twitter">
        </a>
      </p>
    ...
    <div class="sns-list__item">
      <p class="sns-list__icon">
        <a href="https://codepen.io/deren2525/" target="_blank">
          <img src="../../public/assets/img/icon/icon-codepen.svg" draggable="false" alt="CodePen">
        </a>
      </p>
    ...
    <div class="sns-list__item">
      <p class="sns-list__icon">
        <a href="https://github.com/deren2525" target="_blank">
          <img src="../../public/assets/img/icon/icon-github.svg" draggable="false" alt="GitHub">
        </a>
      </p>
